...
function gotJSONData(){
  ...
  try {
    ...
    $("#bsReadJSONH").html("JSON 数据错误。请重试：");
    return;
  }
  xlen = x.length - 1;
  refreshLR();
